...
<h3 align="center">Welcome to the TLDRify project! 😍<br>
We appreciate your interest in contributing.😊<br> </h3>

First off, thank you for considering contributing to **TLDRify!** We're excited to have you join our community. Every contribution, no matter how small, helps us build the best academic resource platform for students.
...
We expect all contributors to follow our **[Code of Conduct](https://github.com/Shantanu-Tiwari/TLDRify/blob/main/CODE_OF_CONDUCT.md)**.
...
By contributing to this project, you agree that your contributions will be licensed under the [MIT License](https://github.com/Shantanu-Tiwari/TLDRify/blob/main/LICENSE.md).
...
Your contributions earn points that count toward GSSoC'25 and your TLDRify Leaderboard status!
...
* ⌛ Reviews may take **24–72 hours** depending on activity. Thanks for your patience!
 ...
 > For Any Query, Send me a DM on Discord community [Shantanu Tiwari](https://discord.gg/SdcTSk8Z)  or on LinkedIn [Shantanu Tiwari](https://www.linkedin.com/in/shantanutiwari24/).
...
- Create a [**Pull Request**](https://github.com/Shantanu-Tiwari/TLDRify/pulls), which will be promptly reviewed and given suggestions for improvements by the community.
